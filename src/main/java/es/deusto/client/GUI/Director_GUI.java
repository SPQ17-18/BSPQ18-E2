...
public class Director_GUI extends JFrame {

	private JPanel contentPane;
	private JTextField textField_SavingID;
	private JTextField textField_SavingName;
	private JTextField textField_SavingDescri;
	private JTextField textField_SavingCondi;
	private JTextField textField_SavingRate;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Director_GUI frame = new Director_GUI();
	...
	public Director_GUI() {
		...
		textField_SavingID = new JTextField();
		textField_SavingID.setBounds(202, 60, 326, 20);
		panel_SavingDesc.add(textField_SavingID);
		textField_SavingID.setColumns(10);
		...
		textField_SavingCondi = new JTextField();
		textField_SavingCondi.setColumns(10);
		textField_SavingCondi.setBounds(202, 251, 326, 84);
		panel_SavingDesc.add(textField_SavingCondi);
		
		textField_SavingRate = new JTextField();
		textField_SavingRate.setColumns(10);
		...
		menuBar_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 12));
		menuBar_1.setBackground(new Color(204, 204, 204));
		menuBar_1.setBounds(10, 11, 116, 21);
		panel.add(menuBar_1);
		
		JMenu mnUsersSettings = new JMenu("User\u00B4s settings\r\n");
		menuBar_1.add(mnUsersSettings);
		
		JMenuItem menuItem_EraseUser = new JMenuItem("Erase User");
		menuItem_EraseUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String id_user = JOptionPane.showInputDialog("Insert User ID: ");
		...
		mnUsersSettings.add(menuItem_EraseUser);
